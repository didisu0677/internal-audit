...
<div class="content-body">
	<?php
	table_open('',true,base_url('settings/auditor/data'),'tbl_m_auditor');
		thead();
			tr();
...
modal_open('modal-form');
	modal_body();
		form_open(base_url('settings/auditor/save'),'post','form');
			col_init(3,9);
			input('hidden','id','id');
...
modal_open('modal-import',lang('impor'));
	modal_body();
		form_open(base_url('settings/auditor/import'),'post','form-import');
			col_init(3,9);
