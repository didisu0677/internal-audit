...
<div class="content-body">
	...
	table_open('',true);
		thead();
			tr();
				th(lang('section_name'));
                th(lang('group_section'),'','width="250"');
				th(lang('description'));
				th(lang('section_code'),'text-center','width="120px"');
	...
	modal_open('modal-form','','modal-lg');
		modal_body();
			form_open(base_url('settings/audit_section/save'),'post','form');
				...
				input('text',lang('section_name'),'section_name','required');
                select2(lang('group_section'),'id_group_section','required',$group_section,'id','group_section');
				input('text',lang('description'),'description');
				
				col_init(3,3);
				input('text',lang('section_code'),'section_code','required');
