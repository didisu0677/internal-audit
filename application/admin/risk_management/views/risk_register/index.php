...
<div class="content-body">
	<?php
	table_open('',true,base_url('risk_management/risk_register/data'),'tbl_risk_register');
		thead();
			tr();
...
modal_open('modal-form');
	modal_body();
		form_open(base_url('risk_management/risk_register/save'),'post','form');
			col_init(3,9);
			input('hidden','id','id');
...
modal_open('modal-import',lang('impor'));
	modal_body();
		form_open(base_url('risk_management/risk_register/import'),'post','form-import');
			col_init(3,9);
