	...
	var konten = '<div class="card mb-2">'
		...
		+ '<div class="form-group row">'
			...
			+ '<div class="col-sm-6">'
				...
				// + '<input type="text" name="file_finding'+'['+(_lampiran != undefined ? _lampiran : idy)+']" id="file_finding'+idy+'" data-validation="required" data-action="http://localhost/internal-audit/upload/file/datetime" data-token="PmFx26Nae" autocomplete="off" class="form-control input-file" placeholder="maksimal 51MB" value="'+(_file != undefined ? _file : '')+'">'
				+ '</div>'
